<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark"> 
            <div class="dropdown">
                ...
                <div class="dropdown-content" style="left:0;">
                    ...
                    <a href=http://localhost:9000/lista>Relatório teste</a>
                </div>
            </div>
            <div class="dropdown">
        ...
        <table class="container w-75 table table-bordered">
            ...
            @forelse ($compras as $compra)
                ...
                <tbody>
                    <tr>
                        ...
                        <td>       
                            <a href= '{{ route('editar_compras', $compra->id) }}'>
                        ...
                        <td>
                            <a href= '{{ route('deletar_compras', $compra->id) }}'>
            ...
            @empty
                <h4 class="card-title text-center">Não hà compras.</h4>      
            @endforelse
        </table>
    </body>
</html>